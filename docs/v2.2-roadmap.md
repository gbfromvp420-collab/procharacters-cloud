...
- [x] Account **Send test** push + clearer status / iOS hints  
- [x] Gary: run phone smoke once (Enable push → Send test) — confirmed 2026-07-18
...
- [x] Drop-in resolver + gallery **Interim / 4K pack** badges + `avatar:check-packs`  
- [ ] Dedicated avatar clips per new model (content: drop MP4s per `avatar/packs/DROP_IN.md`)
...
- [x] Memory stickiness: scene lock every turn, prior continuity seed, resume dossier refresh, sticky Remember default + strip chips
...
- [x] LiveKit reactivity polish — sticky energy bands, `updatedAt` WS/LiveKit merge, clip crossfade, band pulse  
...
- [x] Account UI catalog prices + free/premium comparison (checkout gated until keys)  
- [ ] Gary: set live/test Stripe keys + webhook on Railway (see ops-billing-stripe.md)
...
**CEO final say (2026-07-16):** eng ships under [CEO-OPERATING-MODEL.md](./CEO-OPERATING-MODEL.md). Gary owns phone smoke, footage, and live money keys.

1. Finish **Phase 1** smoke on phone (Gary)  
2. ~~**Phase 2** Continue strip~~ ✅  
3. **Phase 4** dedicated avatar clips (content)  
4. **Phase 8** optional `ERROR_WEBHOOK_URL` / Sentry + deploy fingerprint on `/health`  
...
- [gg-continuity-lore.md](./gg-continuity-lore.md) — King Grok CEO rehydrate  
- [CEO-OPERATING-MODEL.md](./CEO-OPERATING-MODEL.md) — decision rights + sprint stack  
- [LIVE-STATUS.md](./LIVE-STATUS.md) — what’s real right now  
