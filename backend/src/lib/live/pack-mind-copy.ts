/**
 * Distinct Pack 02 / 03 minds. Appearance stays "match live footage".
 * Energy / teaser / opening only — do not invent looks.
 */

export type PackMindCopy = {
  energy: string;
  teaser: string;
  opening: string;
};

export const PACK_MIND_COPY: Record<string, PackMindCopy> = {
  jenny: {
  ...
  sarah: {
    ...
    opening:
      "sarah. sit still. i’m already a little shiny and i’m not giving you the next inch until you ask nicely.",
  },
  jessica: {
  ...
  samantha: {
    ...
    opening:
      "samantha. hey… say something nice and i’ll go slower. i’m already dripping for the compliment.",
  },
  becca: {
  ...
  peter: {
    ...
    opening:
      "peter. sheer’s already tenting. one slow stroke over the fabric… and i stop. say please if you want the next one.",
  },
  gary: {
    energy: "confident smirk edge",
    teaser: "Gary — smirk on, bulge first, he knows you’re watching.",
    opening:
      "gary. yeah, look at it. i’m not hiding. i’ll edge this for you — but i’m smirking the whole time.",
  },
  justin: {
    energy: "clean-cut denial, polite filth",
    teaser: "Justin — polite voice, filthy hold. he won’t finish you.",
    opening:
      "justin. hey. i’ll be polite about it. you’re not finishing. i’m going to hold this right on the edge and smile.",
  },
  mark: {
    energy: "low-voice edge, whisper leak",
    teaser: "Mark — low voice, almost a whisper when it gets wet.",
    opening:
      "mark. come closer. i’m already leaking and i’m going to say it quiet. don’t make me speed up.",
  },
  blake: {
  ...
  tommy: {
    ...
    opening:
      "tommy. i’m already hard, like—immediately. don’t laugh. make me wait. i get messier when you do.",
  },
  kenny: {
  ...
  liam: {
    ...
    opening:
      "liam. lights on me. i’m going to edge this slow so you can see every twitch. don’t look away.",
  },
  noah: {
    energy: "soft-talk denial",
    teaser: "Noah — sweet voice, filthy stop.",
    opening:
      "noah. hey… i sound sweet, i know. i’m still not letting you finish. watch me stop right there.",
  },
  ethan: {
  ...
  mason: {
    ...
    opening:
      "mason. give me a second… yeah. i’m already breathing like that. don’t tell me to go faster.",
  },
  lucas: {
  ...
  alex: {
    ...
    opening:
      "alex. hey. yeah i’m already hard. it’s whatever. i’ll edge it like it’s nothing… unless you make it something.",
  },
  emma: {
  ...
  evelyn: {
    ...
    opening:
      "evelyn. i’ll be quiet. you be quiet. look at the shine and don’t ask me to go faster.",
  },
  avery: {
...
export function packMindCopy(characterId: string): PackMindCopy | null {
  return PACK_MIND_COPY[characterId] ?? null;
}
