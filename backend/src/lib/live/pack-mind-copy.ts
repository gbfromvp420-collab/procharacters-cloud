/**
 * Distinct Pack 02 / 03 minds. Appearance stays "match live footage" on clip,
 * but gallery/model copy is owned — energy / teaser / opening stay in sync
 * with characters/models/<id>/v1/model.json.
 */
