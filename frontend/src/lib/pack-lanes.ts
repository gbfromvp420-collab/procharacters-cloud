/** Live catalog pack membership. Keep in sync with backend/src/lib/live/pack-lanes.ts */
...
export function packLaneLabel(lane: PackLane | null): string {
  if (lane === "01") return "Pack 01";
  if (lane === "02") return "Pack 02";
  if (lane === "03") return "Pack 03";
  return "";
}
